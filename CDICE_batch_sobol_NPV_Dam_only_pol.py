...
S1 = np.zeros((3,stop-start))
S1_conf = np.zeros((3,stop-start))
S2 = np.zeros((3,3,stop-start))
S2_conf = np.zeros((3,3,stop-start))
ST = np.zeros((3,stop-start))
ST_conf = np.zeros((3,stop-start))
